...
log_dir=logs/qa_evaluation/llama-lh5

# Array: name n_articles start_article compute_stats methods target_size query_config algorithm_config use_budget
configs=(
  "t0.99_summarize      2  0 0 original,all 0.99 ss-plus-repeat summarize"
  "t0.99_summarize      2  2 0 original,all 0.99 ss-plus-repeat summarize"
  ...
  "t0.2_fastest-try2              4  0 0 highest_attn_keys_rms_nnls2_-3_3_lsq_on-policy 0.2 ss-plus-repeat best 1"
  #
  "t0.01_fast                4  0 0 omp_nnls0_-inf_7_drop-7_lsq_k4int2_on-policy 0.01 ss-plus-repeat best 1"
  "t0.02_fast                2  0 0 omp_nnls0_-inf_7_drop-7_lsq_k4int2_on-policy 0.02 ss-plus-repeat best 1"
  "t0.02_fast                2  2 0 omp_nnls0_-inf_7_drop-7_lsq_k4int2_on-policy 0.02 ss-plus-repeat best 1"
  ...
  "t0.1_fast                1  0 0 omp_nnls0_-inf_7_drop-7_lsq_k4int4_on-policy 0.1 ss-plus-repeat best 1"
  "t0.1_fast                1  1 0 omp_nnls0_-inf_7_drop-7_lsq_k4int4_on-policy 0.1 ss-plus-repeat best 1"
  "t0.1_fast                1  2 0 omp_nnls0_-inf_7_drop-7_lsq_k4int4_on-policy 0.1 ss-plus-repeat best 1"
  "t0.1_fast                1  3 0 omp_nnls0_-inf_7_drop-7_lsq_k4int4_on-policy 0.1 ss-plus-repeat best 1"
  #
  "t0.01_best                1  0 0 omp_nnls0_-inf_7_drop-7_lsq_on-policy 0.01 ss-plus-repeat best 1"
  "t0.01_best                1  1 0 omp_nnls0_-inf_7_drop-7_lsq_on-policy 0.01 ss-plus-repeat best 1"
  "t0.01_best                1  2 0 omp_nnls0_-inf_7_drop-7_lsq_on-policy 0.01 ss-plus-repeat best 1"
  "t0.01_best                1  3 0 omp_nnls0_-inf_7_drop-7_lsq_on-policy 0.01 ss-plus-repeat best 1"
  "t0.02_best                1  0 0 omp_nnls0_-inf_7_drop-7_lsq_on-policy 0.02 ss-plus-repeat best 1"
  "t0.02_best                1  1 0 omp_nnls0_-inf_7_drop-7_lsq_on-policy 0.02 ss-plus-repeat best 1"
  "t0.02_best                1  2 0 omp_nnls0_-inf_7_drop-7_lsq_on-policy 0.02 ss-plus-repeat best 1"
  "t0.02_best                1  3 0 omp_nnls0_-inf_7_drop-7_lsq_on-policy 0.02 ss-plus-repeat best 1"
  "t0.05_best                1  0 0 omp_nnls0_-inf_7_drop-7_lsq_progressive_on-policy 0.05 ss-plus-repeat best 1"
  "t0.05_best                1  1 0 omp_nnls0_-inf_7_drop-7_lsq_progressive_on-policy 0.05 ss-plus-repeat best 1"
  "t0.05_best                1  2 0 omp_nnls0_-inf_7_drop-7_lsq_progressive_on-policy 0.05 ss-plus-repeat best 1"
  "t0.05_best                1  3 0 omp_nnls0_-inf_7_drop-7_lsq_progressive_on-policy 0.05 ss-plus-repeat best 1"
  #
  ...
  "t0.1_kvzip                4  0 0 global_highest_attn_keys_max_nobeta_direct 0.1 repeat kvzip 0"
